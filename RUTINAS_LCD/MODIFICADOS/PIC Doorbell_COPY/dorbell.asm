...
;-------------------------------------------------------------
; Code generated by PDEL  ver 1.0  on 04/01/1980 at 12:26:01 a.m.
; Description: Waits 40000 cycles
;-------------------------------------------------------------
PDelay  movlw     .93       ; 1 set number of repetitions (B)
        movwf     PDel0     ; 1 |
PLoop1  movlw     .71       ; 1 set number of repetitions (A)
        movwf     PDel1     ; 1 |
